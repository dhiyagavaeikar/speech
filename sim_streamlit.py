...
def sim_support_chatbot():
    ...
    st.markdown(f'<div class="chat-box ai-message">SIM Support Bot: {bot_message}</div>', unsafe_allow_html=True)
    ...
    # Streamlit Interface - Only once for initial page load
    # st.markdown('<div class="chat-box ai-message">SIM Support Bot: Hi! How can I help you today?</div>', unsafe_allow_html=True)
    ...
    while True:
        ...
        if re.search(r'\b(exit|quit|bye)\b', user_input, re.IGNORECASE):
            ...
            st.markdown(f'<div class="chat-box ai-message">SIM Support Bot: {goodbye_text}</div>', unsafe_allow_html=True)
        ...
        st.markdown(f'<div class="chat-box ai-message">SIM Support Bot: {response}</div>', unsafe_allow_html=True)
